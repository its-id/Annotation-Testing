...
// import StandardWorkspace3DComponent from './standard3D-workspace/standard3D-workspace';
import TagAnnotationWorkspace from "./tag-annotation-workspace/tag-annotation-workspace";
import FiltersModalComponent from "./top-bar/filters-modal";
import StatisticsModalComponent from "./top-bar/statistics-modal";
...
export default function AnnotationPageComponent(props: Props): JSX.Element {
  const {
    job,
    closeJob,
    // fetching, frameNumber, getJob , saveLogs, changeFrame
  } = props;
  ...
  //         if (
  //             // parsedFrame !== frameNumber &&
  //             parsedFrame >= job.startFrame && parsedFrame <= job.stopFrame) {
  ...
  //           description: (
  //             <span>
  //               {`${job.projectId ? "Project" : "Task"} ${job.projectId || job.taskId} does not contain any label. `}
  ...
  return (
    <Layout className="cvat-annotation-page">
      ...
      <Layout.Content className="cvat-annotation-layout-content">
        ...
        <StandardWorkspaceComponent /> {/* {workspace === Workspace.STANDARD && <StandardWorkspaceComponent />} */}
        <AttributeAnnotationWorkspace /> {/* {workspace === Workspace.ATTRIBUTE_ANNOTATION && <AttributeAnnotationWorkspace />} */}
        <TagAnnotationWorkspace /> {/* {workspace === Workspace.TAG_ANNOTATION && <TagAnnotationWorkspace />} */}
        <ReviewAnnotationsWorkspace /> {/* {workspace === Workspace.REVIEW_WORKSPACE && <ReviewAnnotationsWorkspace />} */}
      </Layout.Content>
